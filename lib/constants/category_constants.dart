...
class CategoryConstants {
  ...
  static bool isValidCategory(bool isBusinessMode, CategoryType categoryType, String value) {
  ...
  static String normalizeCategory(String value) {
    ...
    final hasTrailingSpace = budgetBusinessCategories.any((cat) => cat.endsWith(' '));
  ...
  static List<String> getCategories(bool isBusinessMode, CategoryType categoryType) {
    switch (categoryType) {
      case CategoryType.budget:
        return isBusinessMode ? budgetBusinessCategories : budgetPersonalCategories;
      
      case CategoryType.expense:
        return isBusinessMode ? expenseBusinessCategories : expensePersonalCategories;
      
      case CategoryType.recurringExpense:
        return isBusinessMode ? recurringExpenseBusinessCategories : recurringExpensePersonalCategories;
    }
  }

  /// Get default category for the given mode and category type
  static String getDefaultCategory(bool isBusinessMode, CategoryType categoryType) {
